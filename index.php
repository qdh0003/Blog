...
<head>
    ...
    <title>Blog | QUICKSAND</title>
</head>

<body>
    
    <!-- PHP to include header code to keep from repeating it in multiple files. -->
    <?php include(ROOT_PATH . "/app/includes/header.php"); ?>

    <!-- PHP to include successful login message -->
    ...
    <!-- PHP to include footer code to keep from repeating -->
